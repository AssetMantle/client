...
ALTER TABLE IF EXISTS BLOCKCHAIN."Asset_BC"
    ADD COLUMN "classificationID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Asset_BC"
    ADD COLUMN "hashID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Asset_BC"
...
ALTER TABLE IF EXISTS BLOCKCHAIN."Classification_BC"
    DROP COLUMN IF EXISTS "id";
ALTER TABLE IF EXISTS BLOCKCHAIN."Classification_BC"
    ADD COLUMN "chainID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Classification_BC"
    ADD COLUMN "hashID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Classification_BC"
...
ALTER TABLE IF EXISTS BLOCKCHAIN."IdentityUnprovision_BC"
    DROP CONSTRAINT IF EXISTS IdentityUnprovisioned_BC;
...
ALTER TABLE IF EXISTS BLOCKCHAIN."Maintainer_BC"
    ADD COLUMN "classificationID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Maintainer_BC"
    ADD COLUMN "identityID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Maintainer_BC"
...
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
    ADD COLUMN "classificationID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
    ADD COLUMN "makerOwnableID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
    ADD COLUMN "takerOwnableID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
    ADD COLUMN "rateID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
    ADD COLUMN "creationID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
    ADD COLUMN "makerID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
    ADD COLUMN "hashID" VARCHAR NOT NULL default '';
ALTER TABLE IF EXISTS BLOCKCHAIN."Order_BC"
