...
CREATE TABLE IF NOT EXISTS MASTER."IdentityNub"
(
    "identityID"        VARCHAR NOT NULL,
    "nubID"             VARCHAR NOT NULL UNIQUE,
...
ALTER TABLE MASTER."IdentityNub"
    ADD CONSTRAINT IdentityNub_identity_id FOREIGN KEY ("identityID") REFERENCES BLOCKCHAIN."Identity_BC" ("id");
ALTER TABLE MASTER."IdentityNub"
    ADD CONSTRAINT IdentityNub_Creator_address FOREIGN KEY ("creatorAddress") REFERENCES BLOCKCHAIN."Account_BC" ("address");
...
DROP TRIGGER IF EXISTS IDENTITY_NUB_LOG ON MASTER."IdentityNub" CASCADE;
...
DROP TABLE IF EXISTS MASTER."IdentityNub" CASCADE;
