...
CREATE TRIGGER ACL_ACCOUNT_BC_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN."ACLAccount_BC" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ACL_HASH_BC_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN."ACLHash_BC" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER TRADER_FEEDBACK_HISTORY_BC_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN."TraderFeedbackHistory_BC" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER TRANSACTION_FEEDBACK_BC_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN."TransactionFeedBack_BC" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER ADD_ORGANIZATION_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."AddOrganization" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ADD_ZONE_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."AddZone" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER BUYER_EXECUTE_ORDER_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."BuyerExecuteOrder" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER CHANGE_BUYER_BID_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."ChangeBuyerBid" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER CHANGE_SELLER_BID_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."ChangeSellerBid" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER CONFIRM_BUYER_BID_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."ConfirmBuyerBid" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER CONFIRM_SELLER_BID_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."ConfirmSellerBid" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ISSUE_ASSET_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."IssueAsset" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ISSUE_FIAT_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."IssueFiat" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER REDEEM_ASSET_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."RedeemAsset" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER REDEEM_FIAT_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."RedeemFiat" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER RELEASE_ASSET_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."ReleaseAsset" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SELLER_EXECUTE_ORDER_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."SellerExecuteOrder" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SEND_ASSET_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."SendAsset" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SEND_COIN_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."SendCoin" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SEND_FIAT_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."SendFiat" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SET_ACL_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."SetACL" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SET_BUYER_FEEDBACK_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."SetBuyerFeedback" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SET_SELLER_FEEDBACK_LOG BEFORE INSERT OR UPDATE ON BLOCKCHAIN_TRANSACTION."SetSellerFeedback" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER OAUTH_TOKEN_LOG BEFORE INSERT OR UPDATE ON DOCUSIGN."OAuthToken" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER ACCOUNT_FILE_LOG BEFORE INSERT OR UPDATE ON MASTER."AccountFile" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ACCOUNT_KYC_LOG BEFORE INSERT OR UPDATE ON MASTER."AccountKYC" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER ORGANIZATION_BACKGROUND_CHECK_LOG BEFORE INSERT OR UPDATE ON MASTER."OrganizationBackgroundCheck" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ORGANIZATION_BANK_ACCOUNT_DETAIL_LOG BEFORE INSERT OR UPDATE ON MASTER."OrganizationBankAccountDetail" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ORGANIZATION_KYC_LOG BEFORE INSERT OR UPDATE ON MASTER."OrganizationKYC" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER TRADER_BACKGROUND_CHECK_LOG BEFORE INSERT OR UPDATE ON MASTER."TraderBackgroundCheck" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER TRADER_RELATION_LOG BEFORE INSERT OR UPDATE ON MASTER."TraderRelation" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER ZONE_KYC_LOG BEFORE INSERT OR UPDATE ON MASTER."ZoneKYC" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();

CREATE TRIGGER ASSET_FILE_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."AssetFile" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER EMAIL_OTP_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."EmailOTP" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER FAUCET_REQUEST_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."FaucetRequest" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER MESSAGE_READ_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."MessageRead" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER NEGOTIATION_FILE_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."NegotiationFile" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER PUSH_NOTIFICATION_TOKEN_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."PushNotificationToken" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER REDEEM_FIAT_REQUEST_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."RedeemFiatRequest" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SEND_FIAT_REQUEST_TOKEN_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."SendFiatRequest" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SESSION_TOKEN_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."SessionToken" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER SMS_OTP_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."SMSOTP" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER TRADE_ACTIVITY_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."TradeActivity" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER TRADER_INVITATION_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."TraderInvitation" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
CREATE TRIGGER ZONE_INVITATION_LOG BEFORE INSERT OR UPDATE ON MASTER_TRANSACTION."ZoneInvitation" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();

CREATE TRIGGER FIAT_REQUEST_LOG BEFORE INSERT OR UPDATE ON WESTERN_UNION."FiatRequest" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
...
CREATE TRIGGER SFTP_FILE_TRANSACTION_LOG BEFORE INSERT OR UPDATE ON WESTERN_UNION."SFTPFileTransaction" FOR EACH ROW EXECUTE PROCEDURE public.insert_or_update_log();
