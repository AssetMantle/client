...
CREATE INDEX CREATED_ON_DESC_MESSAGE ON MASTER_TRANSACTION."Message" ("createdOn" DESC);

CREATE INDEX HEIGHT_DESC_TRANSACTION ON BLOCKCHAIN."Transaction" ("height" DESC);

CREATE INDEX HEIGHT_DESC_BLOCK ON BLOCKCHAIN."Block" ("height" DESC);

CREATE INDEX CREATED_ON_DESC_NOTIFICATION ON MASTER_TRANSACTION."Notification" ("createdOn" DESC);

CREATE INDEX SERIAL_DESC_TOKEN_PRICE ON MASTER_TRANSACTION."TokenPrice" ("serial" DESC);
