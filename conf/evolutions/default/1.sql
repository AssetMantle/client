...
CREATE TABLE IF NOT EXISTS MASTER."WorldCheckKyc"
(
...
CREATE TABLE IF NOT EXISTS MASTER."WorldCheckKycFile"
(
    "id"                VARCHAR NOT NULL,
    "status"            BOOLEAN,
...
CREATE TABLE IF NOT EXISTS MASTER."WorldCheckScreeningCheck"
(
    "id"                VARCHAR NOT NULL,
    "status"            BOOLEAN,
    "checkType" 		VARCHAR,
...
ALTER TABLE MASTER."WorldCheckKycFile"
    ADD CONSTRAINT KYCCheckFile_id FOREIGN KEY ("id") REFERENCES MASTER."WorldCheckKyc" ("id");

ALTER TABLE MASTER."WorldCheckScreeningCheck"
    ADD CONSTRAINT KYCCheck_Account_id FOREIGN KEY ("id") REFERENCES MASTER."WorldCheckKyc" ("id");
/*Triggers*/
...
CREATE TRIGGER WorldCheckKyc_LOG
    BEFORE INSERT OR UPDATE
    ON MASTER."WorldCheckKyc"
    FOR EACH ROW
EXECUTE PROCEDURE PUBLIC.INSERT_OR_UPDATE_LOG();

CREATE TRIGGER WorldCheckKycFile_LOG
    BEFORE INSERT OR UPDATE
    ON MASTER."WorldCheckKycFile"
    FOR EACH ROW
EXECUTE PROCEDURE PUBLIC.INSERT_OR_UPDATE_LOG();

CREATE TRIGGER WorldCheckScreeningCheck_LOG
    BEFORE INSERT OR UPDATE
    ON MASTER."WorldCheckScreeningCheck"
    FOR EACH ROW
EXECUTE PROCEDURE PUBLIC.INSERT_OR_UPDATE_LOG();
...
DROP TRIGGER IF EXISTS ACCOUNT_KYC_LOG ON MASTER."WorldCheckKyc" CASCADE;
DROP TRIGGER IF EXISTS ACCOUNT_KYC_LOG ON MASTER."WorldCheckKycFile" CASCADE;
DROP TRIGGER IF EXISTS ACCOUNT_KYC_LOG ON MASTER."WorldCheckScreeningCheck" CASCADE;
...
DROP TABLE IF EXISTS MASTER."WorldCheckKyc" CASCADE;
DROP TABLE IF EXISTS MASTER."WorldCheckKycFile" CASCADE;
DROP TABLE IF EXISTS MASTER."WorldCheckScreeningCheck" CASCADE;