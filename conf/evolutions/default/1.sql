...
CREATE TABLE IF NOT EXISTS MASTER_TRANSACTION."ChatReceive"
(
...
ALTER TABLE MASTER_TRANSACTION."ChatReceive"
    ADD CONSTRAINT ChatReceive_Chat_chatID FOREIGN KEY ("chatID") REFERENCES MASTER_TRANSACTION."Chat"("id");
...
DROP TABLE IF EXISTS MASTER_TRANSACTION."TradeRoom" CASCADE;
DROP TABLE IF EXISTS MASTER_TRANSACTION."TradeRoomParticipant" CASCADE;
DROP TABLE IF EXISTS MASTER_TRANSACTION."ChatWindow" CASCADE;
DROP TABLE IF EXISTS MASTER_TRANSACTION."ChatWindowParticipant" CASCADE;
DROP TABLE IF EXISTS MASTER_TRANSACTION."Chat" CASCADE;
DROP TABLE IF EXISTS MASTER_TRANSACTION."ChatReceive" CASCADE;
