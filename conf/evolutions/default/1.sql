...
CREATE TABLE IF NOT EXISTS MASTER_TRANSACTION."Docusign"
(
    "id"         VARCHAR NOT NULL,
...
ALTER TABLE MASTER_TRANSACTION."AssetFile"
    ADD CONSTRAINT AssetFile_IssueAssetRequest_id FOREIGN KEY ("id") REFERENCES MASTER."Asset" ("id");
...
ALTER TABLE MASTER_TRANSACTION."Docusign"
    ADD CONSTRAINT Docusign_MasterNegotiation_id FOREIGN KEY ("id") REFERENCES MASTER."Negotiation" ("id");
...
DROP TABLE IF EXISTS MASTER_TRANSACTION."Docusign" CASCADE;
