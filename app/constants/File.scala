...
object File {
  ...
  val ORGANIZATION_KYC_DOCUMENT_TYPES: Seq[String] = Seq(BANK_ACCOUNT_DETAIL, LATEST_AUDITED_FINANCIAL_REPORT, LAST_YEAR_AUDITED_FINANCIAL_REPORT, MANAGEMENT, ACRA, SHARE_STRUCTURE, ADMIN_PROFILE_IDENTIFICATION, ORGANIZATION_AGREEMENT)
  val TRADER_KYC_DOCUMENT_TYPES: Seq[String] = Seq(TRADER_IDENTIFICATION, TRADER_AGREEMENT)
}
