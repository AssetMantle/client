...
object Form {
  ...
  val WALLEX_TRADER_COMPANY_ACCOUNT_UPDATE = new Form("WALLEX_TRADER_COMPANY_ACCOUNT_UPDATE", routes.WallexController.updateCompanyAccount(), routes.javascript.WallexController.updateCompanyAccountForm)
