...
object Form {
  ...
  val UNMODERATED_SELLER_EXECUTE_ORDER = "UNMODERATED_SELLER_EXECUTE_ORDER"
  val UNMODERATED_BUYER_EXECUTE_ORDER = "UNMODERATED_BUYER_EXECUTE_ORDER"
