...
object Response {
  ...
  val NOT_LOGGED_IN = new Failure("NOT_LOGGED_IN", routes.javascript.AccountController.loginForm)
  val SESSION_TIMED_OUT = new Failure("SESSION_TIMED_OUT", routes.javascript.AccountController.loginForm)
