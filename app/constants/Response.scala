...
object Response {
  ...
  val WALLEX_ACCOUNT_DETAILS_UPDATED = new Success("WALLEX_ACCOUNT_DETAILS_UPDATED")
  val WALLEX_DOCUMENT_SUBMITTED = new Success("WALLEX_DOCUMENT_SUBMITTED")
  val WALLEX_BENEFICIARY_DETAILS_SUBMITTED = new Success("WALLEX_BENEFICIARY_DETAILS_SUBMITTED")
  val WALLEX_BENEFICIARY_DETAILS_DELETED = new Success("WALLEX_BENEFICIARY_DETAILS_DELETED")
  ...
  val UNKNOWN_HOST_EXCEPTION= new Failure("UNKNOWN_HOST_EXCEPTION")
  ...
  val EMAIL_SEND_FAILED = new Failure("EMAIL_SEND_FAILED")
  ...
  val WALLEX_WALLET_LOW_BALANCE = new Failure("WALLEX_WALLET_LOW_BALANCE")
  val WALLEX_EXCEPTION = new Failure("WALLEX_EXCEPTION")
