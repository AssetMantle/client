...
object Response {
  ...
  val BUYER_SENT_CONFIRM_NEGOTIATION_TRANSACTION_TO_BLOCKCHAIN = new Success("BUYER_SENT_CONFIRM_NEGOTIATION_TRANSACTION_TO_BLOCKCHAIN")
  val SELLER_SENT_CONFIRM_NEGOTIATION_TRANSACTION_TO_BLOCKCHAIN = new Success("SELLER_SENT_CONFIRM_NEGOTIATION_TRANSACTION_TO_BLOCKCHAIN")
  ...
  val ALL_NEGOTIATION_TERMS_NOT_ACCEPTED = new Failure("ALL_NEGOTIATION_TERMS_NOT_ACCEPTED")
  ...
  val BILL_OF_LADING_NOT_VERIFIED = new Failure("BILL_OF_LADING_NOT_VERIFIED")
