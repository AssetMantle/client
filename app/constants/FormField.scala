...
object FormField {
  ...
  val ZONE_ID = new StringFormField("ZONE_ID", 35, 35, RegularExpression.ID)
  val ORGANIZATION_ID = new StringFormField("ORGANIZATION_ID", 35, 35, RegularExpression.ID)
  val TRADER_ID = new StringFormField("TRADER_ID", 35, 35, RegularExpression.ID)
  ...
  val FROM_ID = new StringFormField("FROM_ID", 35, 35, RegularExpression.ID)
  val TO_ID = new StringFormField("TO_ID", 35, 35, RegularExpression.ID)
  val COUNTER_PARTY = new StringFormField("COUNTER_PARTY", 2, 100)
  val SALES_QUOTE_ID = new StringFormField("SALES_QUOTE_ID", 32, 32)
  val ASSET_ID = new StringFormField("ASSET_ID", 35, 35, RegularExpression.ID)
