...
object FormField {
  ...
  val FIAT_PROOF = new StringFormField("FIAT_PROOF", 1, 1000,RegularExpression.ALL_NUMBERS_ALL_LETTERS)
  ...
  val CONTRACT_NUMBER = new StringFormField("CONTRACT_NUMBER", 2, 100,RegularExpression.ALL_NUMBERS_ALL_LETTERS)
