...
object FormField {
  ...
  val WALLEX_COUNTRY_OF_BIRTH = new StringFormField("WALLEX_COUNTRY_OF_BIRTH", 0,255)
  val WALLEX_COUNTRY_OF_RESIDENCE = new StringFormField("WALLEX_COUNTRY_OF_RESIDENCE", 0,255)
