...
object FormField {
  ...
  val BILL_OF_LADING_NUMBER = new StringFormField("BILL_OF_LADING_NUMBER", 2, 500, RegularExpression.BILL_OF_LADING)
  val CONSIGNEE_TO = new StringFormField("CONSIGNEE_TO", 2, 100)
  val VESSEL_NAME = new StringFormField("VESSEL_NAME", 2, 100)
  val SHIPPER_NAME = new StringFormField("SHIPPER_NAME", 2, 20, RegularExpression.BILL_OF_LADING)
  val SHIPPER_ADDRESS = new StringFormField("SHIPPER_ADDRESS", 2, 100, RegularExpression.BILL_OF_LADING)
  val NOTIFY_PARTY_NAME = new StringFormField("NOTIFY_PARTY_NAME", 2, 20, RegularExpression.BILL_OF_LADING)
  val NOTIFY_PARTY_ADDRESS = new StringFormField("NOTIFY_PARTY_ADDRESS", 2, 100, RegularExpression.BILL_OF_LADING)
