...
object FormField {
  ...
  val ZONE_ID = new StringFormField("ZONE_ID", 8, 100)
  val ORGANIZATION_ID = new StringFormField("ORGANIZATION_ID", 8, 100)
  val TRADER_ID = new StringFormField("TRADER_ID", 8, 100)
