...
object FormField {
  ...
  val PORT_OF_LOADING = new StringFormField("PORT_OF_LOADING", 3, 100, RegularExpression.NAME)
  val PORT_OF_DISCHARGE = new StringFormField("PORT_OF_DISCHARGE", 3, 100, RegularExpression.NAME)
  val BILL_OF_LADING_NUMBER = new StringFormField("BILL_OF_LADING_NUMBER", 2, 500, RegularExpression.DOCUMENT_NUMBER)
  val CONSIGNEE_TO = new StringFormField("CONSIGNEE_TO", 2, 100, RegularExpression.NAME)
  ...
  val INVOICE_NUMBER = new StringFormField("INVOICE_NUMBER", 2, 32, RegularExpression.DOCUMENT_NUMBER)
  val CONTRACT_NUMBER = new StringFormField("CONTRACT_NUMBER", 2, 100, RegularExpression.DOCUMENT_NUMBER)
  ...
  val WALLEX_POSTAL_ZIP_CODE = new StringFormField("WALLEX_POSTAL_ZIP_CODE", 2, 100)
  ...
  val ASSET_DESCRIPTION = new StringFormField("ASSET_DESCRIPTION", 1, 1000, RegularExpression.NAME)
  ...
  val WALLEX_CURRENCY_PAIR = new StringFormField("WALLEX_CURRENCY_PAIR", 1, 100)
  val WALLEX_BUY_CURRENCY = new StringFormField("WALLEX_BUY_CURRENCY", 1, 100)
  val WALLEX_SELL_CURRENCY = new StringFormField("WALLEX_SELL_CURRENCY", 1, 100)
  val WALLEX_EXPIRES_AT = new StringFormField("WALLEX_EXPIRES_AT", 1, 100)
  val WALLEX_QUOTE_ID = new StringFormField("WALLEX_QUOTE_ID", 1, 100)
  val WALLEX_PAYMENT_CHANNEL = new StringFormField("WALLEX_PAYMENT_CHANNEL", 1, 100)
  val WALLEX_FIXED_SIDE = new StringFormField("WALLEX_FIXED_SIDE", 0, 100)
  val WALLEX_DOCUMENT_NAME = new StringFormField("WALLEX_DOCUMENT_NAME", 1, 100)
  val WALLEX_ABA = new StringFormField("WALLEX_ABA", 0, 9)
  val WALLEX_STATE_OR_PROVINCE = new StringFormField("WALLEX_STATE_OR_PROVINCE", 0, 255)
  val WALLEX_COMPANY_ADDRESS = new StringFormField("WALLEX_COMPANY_ADDRESS", 1, 255)
  val WALLEX_BANK_ADDRESS = new StringFormField("WALLEX_BANK_ADDRESS", 1, 255)
  val WALLEX_BENEFICIARY_ID = new StringFormField("WALLEX_BENEFICIARY_ID", 1, 255)
  val WALLEX_PAYMENT_REFERENCE = new StringFormField("WALLEX_PAYMENT_REFERENCE", 0, 255)
  val WALLEX_ON_BEHALF_OF = new StringFormField("WALLEX_ON_BEHALF_OF", 1, 255)
  val WALLEX_RECEIVER_ACCOUNT_ID = new StringFormField("WALLEX_RECEIVER_ACCOUNT_ID", 1, 255)
  val WALLEX_REMARKS = new StringFormField("WALLEX_REMARKS", 0, 255)
  val WALLEX_REFERENCE = new StringFormField("WALLEX_REFERENCE", 0,255)
  val WALLEX_REGISTRATION_NUMBER = new StringFormField("WALLEX_REGISTRATION_NUMBER", 0,255)
  val DESCRIPTION = new StringFormField("DESCRIPTION", 0,255)
  val WALLEX_PURPOSE = new StringFormField("WALLEX_PURPOSE", 0,255)
  val WALLEX_USER_ID = new StringFormField("WALLEX_USER_ID", 0,255)
  val WALLEX_RESIDENTIAL_ADDRESS = new StringFormField("WALLEX_RESIDENTIAL_ADDRESS", 0,255)
  val WALLEX_IDENTIFICATION_NUMBER = new StringFormField("WALLEX_IDENTIFICATION_NUMBER", 0,255)
  val WALLEX_US_POSTAL_CODE = new StringFormField("WALLEX_US_POSTAL_CODE", 0,255)
  ...
  val WALLEX_COUNTRY_CODE = new SelectFormField("WALLEX_COUNTRY_CODE", constants.SelectFieldOptions.WALLEX_COUNTRY_CODE)
  val WALLEX_NATIONALITY = new SelectFormField("WALLEX_NATIONALITY", constants.SelectFieldOptions.WALLEX_COUNTRY_CODE)
  val WALLEX_COUNTRY_OF_OPERATIONS = new SelectFormField("WALLEX_COUNTRY_OF_OPERATIONS", constants.SelectFieldOptions.WALLEX_COUNTRY_CODE)
  val WALLEX_COUNTRY_OF_INCORPORATION = new SelectFormField("WALLEX_COUNTRY_OF_INCORPORATION", constants.SelectFieldOptions.WALLEX_COUNTRY_CODE)
  val WALLEX_ACCOUNT_TYPE = new SelectFormField("WALLEX_ACCOUNT_TYPE", constants.SelectFieldOptions.ACCOUNT_TYPE)
  val WALLEX_ENTITY_TYPE = new SelectFormField("WALLEX_ENTITY_TYPE", constants.SelectFieldOptions.ACCOUNT_TYPE)
  val WALLEX_CURRENCIES_SELL = new SelectFormField("WALLEX_CURRENCIES_SELL", constants.SelectFieldOptions.WALLEX_CURRENCIES)
  val WALLEX_CURRENCIES_BUY = new SelectFormField("WALLEX_CURRENCIES_BUY", constants.SelectFieldOptions.WALLEX_CURRENCIES)
  val WALLEX_CURRENCIES = new SelectFormField("WALLEX_CURRENCIES", constants.SelectFieldOptions.WALLEX_CURRENCIES)
  val WALLEX_DOCUMENT_TYPE = new SelectFormField("WALLEX_DOCUMENT_TYPE", constants.SelectFieldOptions.WALLEX_DOCUMENT_TYPE)
  val WALLEX_FUNDING_SOURCE = new SelectFormField("WALLEX_FUNDING_SOURCE", constants.SelectFieldOptions.WALLEX_FUNDING_SOURCE)
  val WALLEX_PURPOSE_OF_TRANSFER = new SelectFormField("WALLEX_PURPOSE_OF_TRANSFER", constants.SelectFieldOptions.WALLEX_PURPOSE_OF_TRANSFER)
  val WALLEX_BUSINESS_TYPE = new SelectFormField("WALLEX_BUSINESS_TYPE", constants.SelectFieldOptions.WALLEX_BUSINESS_TYPE)
  val WALLEX_GENDER = new SelectFormField("WALLEX_GENDER", constants.SelectFieldOptions.WALLEX_GENDER)
  val WALLEX_IDENTIFICATION_TYPE = new SelectFormField("WALLEX_IDENTIFICATION_TYPE", constants.SelectFieldOptions.WALLEX_IDENTIFICATION_DOCUMENT_TYPE)
  val WALLEX_EMPLOYMENT_INDUSTRY = new SelectFormField("WALLEX_EMPLOYMENT_INDUSTRY", constants.SelectFieldOptions.WALLEX_EMPLOYMENT_INDUSTRY)
  val WALLEX_EMPLOYMENT_STATUS = new SelectFormField("WALLEX_EMPLOYMENT_STATUS", constants.SelectFieldOptions.WALLEX_EMPLOYMENT_STATUS)
  val WALLEX_EMPLOYMENT_POSITION = new SelectFormField("WALLEX_EMPLOYMENT_POSITION", constants.SelectFieldOptions.WALLEX_EMPLOYMENT_POSITION)
  ...
  val WALLEX_INCORPORATION_DATE = new DateFormField("WALLEX_INCORPORATION_DATE")
  val WALLEX_ISSUE_DATE = new DateFormField("WALLEX_ISSUE_DATE")
  val WALLEX_EXPIRY_DATE = new DateFormField("WALLEX_EXPIRY_DATE")
  ...
  val WALLEX_BUY_AMOUNT = new DoubleFormField("WALLEX_BUY_AMOUNT", 0.0, 1000000000000000.00)
  val WALLEX_SELL_AMOUNT = new DoubleFormField("WALLEX_SELL_AMOUNT", 0.0, 1000000000000000.00)
  val WALLEX_RATE = new DoubleFormField("WALLEX_RATE", 0.0, 1000000000000000.00)
  val WALLEX_PARTNER_RATE = new DoubleFormField("WALLEX_PARTNER_RATE", 0.0, 1000000000000000.00)
  val WALLEX_PARTNER_BUY_AMOUNT = new DoubleFormField("WALLEX_PARTNER_BUY_AMOUNT", 0.0, 1000000000000000.00)
  val WALLEX_PARTNER_SELL_AMOUNT = new DoubleFormField("WALLEX_PARTNER_SELL_AMOUNT", 0.0, 1000000000000000.00)
  val WALLEX_PARTNER_PAYMENT_FEE = new DoubleFormField("WALLEX_PARTNER_PAYMENT_FEE", 0.0, 1000000000000000.00)
  val WALLEX_PAYMENT_FEE = new DoubleFormField("WALLEX_PAYMENT_FEE", 0.0, 1000000000000000.00)
  val WALLEX_TOTAL_FEE = new DoubleFormField("WALLEX_TOTAL_FEE", 0.0, 1000000000000000.00)
  ...
  val WALLEX_SUPPORTING_DOCUMENT_REQUIRED = new BooleanFormField("WALLEX_SUPPORTING_DOCUMENT_REQUIRED")
  val WALLEX_ACCEPT_PAYMENT = new BooleanFormField("WALLEX_ACCEPT_PAYMENT")
