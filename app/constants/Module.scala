...
object Module {
  ...
  val ORGANIZATION_WALLEX_ACCOUNT ="MASTER_ORGANIZATION_WALLEX_ACCOUNT"
  val WALLEX_CONTROLLER = "WALLEX_CONTROLLER"
  val WALLEX_DOCUMENT ="MASTER_WALLEX_DOCUMENT"
  val ORGANIZATION_WALLEX_BENEFICIARY_DETAILS ="MASTER_ORGANIZATION_WALLEX_BENEFICIARY_DETAILS"
  val WALLEX_QUOTE_DETAILS ="MASTER_WALLEX_QUOTE_DETAILS"
  val WALLEX_PAYMENT_DETAILS ="MASTER_WALLEX_PAYMENT_DETAILS"
  val WALLEX_WALLET_TRANSFER ="MASTER_WALLEX_WALLET_TRANSFER"
  val WALLEX_PAYMENT_FILE ="MASTER_WALLEX_PAYMENT_FILE"
  ...
  val TRANSACTIONS_WALLEX_PAYMENT_URL ="TRANSACTIONS_WALLEX_PAYMENT_URL"
