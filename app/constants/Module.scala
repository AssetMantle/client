...
object Module {
  ...
  val KYC_CONTROLLER = "KYC_CONTROLLER"
  ...
  //world check kyc
  val WORLD_CHECK_KYC = "WORLD_CHECK_KYC"
  val WORLD_CHECK_KYC_FILE = "WORLD_CHECK_KYC_FILE"
  val WORLD_CHECK_SCREENING_CHECK = "WORLD_CHECK_SCREENING_CHECK"
