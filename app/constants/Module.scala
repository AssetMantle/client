...
object Module {
  ...
  val TRANSACTIONS_GET_FEEDBACK = "TRANSACTIONS_GET_FEEDBACK"
  val TRANSACTIONS_GET_BLOCK_HEIGHT = "TRANSACTIONS_GET_BLOCK_HEIGHT"
  ...
  val TRANSACTIONS_GET_TRANSACTION_HASH = "TRANSACTIONS_GET_TRANSACTION_HASH"
  ...
  val MASTER_TRANSACTION_FAUCET_REQUESTS = "FAUCET_REQUESTS"
  val MASTER_TRANSACTION_ISSUE_ASSET_REQUESTS = "ISSUE_ASSET_REQUESTS"
  val MASTER_TRANSACTION_ISSUE_FIAT_REQUESTS = "ISSUE_FIAT_REQUESTS"
  ...
  val CONTROLLERS_ADD_ORGANIZATION = "ADD_ORGANIZATION"
  val CONTROLLERS_ADD_ZONE = "ADD_ZONE"
  ...
  val CONTROLLERS_BUYER_EXECUTE_ORDER="BUYER_EXECUTE_ORDER"
  val CONTROLLERS_SELLER_EXECUTE_ORDER="SELLER_EXECUTE_ORDER"
  val CONTROLLERS_CHANGE_BUYER_BID="CHANGE_BUYER_BID"
  val CONTROLLERS_CHANGE_SELLER_BID="CHANGE_SELLER_BID"
  val CONTROLLERS_CONFIRM_BUYER_BID="CONFIRM_BUYER_BID"
  val CONTROLLERS_CONFIRM_SELLER_BID="CONFIRM_SELLER_BID"
  val CONTROLLERS_ISSUE_ASSET="ISSUE_ASSET"
  val CONTROLLERS_ISSUE_FIAT="ISSUE_FIAT"
  val CONTROLLERS_REDEEM_ASSET="REDEEM_ASSET"
  val CONTROLLERS_REDEEM_FIAT="REDEEM_FIAT"
  val CONTROLLERS_RELEASE_ASSET="RELEASE_ASSET"
  val CONTROLLERS_SEND_ASSET="SEND_ASSET"
  val CONTROLLERS_SEND_COIN="SEND_COIN"
  val CONTROLLERS_SEND_FIAT="SEND_FIAT"
  val CONTROLLERS_SET_ACL="SET_ACL"
  val CONTROLLERS_SET_BUYER_FEEDBACK="SET_BUYER_FEEDBACK"
  val CONTROLLERS_SET_SELLER_FEEDBACK="SET_SELLER_FEEDBACK"
  //Actions
  ...
  //Utilities
  val UTILITIES_PUSH_NOTIFICATION = "UTILITIES_PUSH_NOTIFICATION"
  val UTILITIES_EMAIL = "UTILITIES_EMAIL"
  val UTILITIES_SMS = "UTILITIES_SMS"
