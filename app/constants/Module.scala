...
object Module {
  ...
  val WALLEX_ORGANIZATION_ACCOUNT ="WALLEX_ORGANIZATION_ACCOUNT"
  val WALLEX_CONTROLLER = "WALLEX_CONTROLLER"
  val WALLEX_DOCUMENT ="WALLEX_DOCUMENT"
  val WALLEX_BENEFICIARY ="WALLEX_BENEFICIARY"
  val WALLEX_QUOTE_DETAILS ="WALLEX_QUOTE_DETAILS"
  val WALLEX_PAYMENT_DETAILS ="WALLEX_PAYMENT_DETAILS"
  val WALLEX_WALLET_TRANSFER ="WALLEX_WALLET_TRANSFER"
  val WALLEX_PAYMENT_FILE ="WALLEX_PAYMENT_FILE"
  val WALLEX_ZONE_CONTROLLER ="WALLEX_ZONE_CONTROLLER"
  val WALLEX_KYC_DETAIL ="WALLEX_KYC_DETAIL"
  val WALLEX_COLLECTION_ACCOUNT ="WALLEX_COLLECTION_ACCOUNT"
  val WALLEX_WALLET_TRANSFER_REQUEST ="WALLEX_WALLET_TRANSFER_REQUEST"
  val WALLEX_FUNDING_STATUS ="WALLEX_FUNDING_STATUS"
  val WALLEX_ACCOUNT_COMPANY ="WALLEX_ACCOUNT_COMPANY"
  val WALLEX_ACCOUNT_PROFILE ="WALLEX_ACCOUNT_PROFILE"
  ...
  val TRANSACTIONS_WALLEX_USER_SIGNUP = "TRANSACTIONS_WALLEX_USER_SIGNUP"
  val TRANSACTIONS_WALLEX_AUTH_TOKEN = "TRANSACTIONS_WALLEX_AUTH_TOKEN"
  val TRANSACTIONS_WALLEX_GET_USER = "TRANSACTIONS_WALLEX_GET_USER"
  val TRANSACTIONS_WALLEX_CREATE_PAYMENT_QUOTE = "TRANSACTIONS_WALLEX_CREATE_PAYMENT_QUOTE"
  val TRANSACTIONS_WALLEX_CREATE_BENEFICIARY = "TRANSACTIONS_WALLEX_CREATE_BENEFICIARY"
  val TRANSACTIONS_WALLEX_PAYMENT_FILE = "TRANSACTIONS_WALLEX_PAYMENT_FILE"
  val TRANSACTIONS_WALLEX_USER_UPDATE_ACCOUNT = "TRANSACTIONS_WALLEX_USER_UPDATE_ACCOUNT"
  val TRANSACTIONS_WALLEX_COLLECTION_CREATE = "TRANSACTIONS_WALLEX_COLLECTION_CREATE"
  val TRANSACTIONS_WALLEX_COLLECTION_GET = "TRANSACTIONS_WALLEX_COLLECTION_GET"
  val TRANSACTIONS_WALLEX_WALLET_BALANCE = "TRANSACTIONS_WALLEX_WALLET_BALANCE"
  val TRANSACTIONS_WALLEX_USER_SCREENING = "TRANSACTIONS_WALLEX_USER_SCREENING"
  val TRANSACTIONS_WALLEX_GET_FUNDING = "TRANSACTIONS_WALLEX_GET_FUNDING"
  val TRANSACTIONS_WALLEX_USER_UPDATE_COMPANY = "TRANSACTIONS_WALLEX_USER_UPDATE_COMPANY"
  val TRANSACTIONS_WALLEX_CREATE_DOCUMENT = "TRANSACTIONS_WALLEX_CREATE_DOCUMENT"
  val TRANSACTIONS_WALLEX_DELETE_DOCUMENT = "TRANSACTIONS_WALLEX_DELETE_DOCUMENT"
