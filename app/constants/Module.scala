...
object Module {
  ...
  val QUERIES_GET_UNCONFIRMED_TXS = "QUERIES_GET_UNCONFIRMED_TXS"
  ...
  val CAMPAIGN_CLAIM_NAME = "CAMPAIGN_CLAIM_NAME"
  val CAMPAIGN_REVERT_CLAIM_NAME = "CAMPAIGN_REVERT_CLAIM_NAME"
}
