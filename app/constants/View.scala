...
object View {
  ...
  val WALLEX_UPLOAD_KYC ="WALLEX_UPLOAD_KYC"
  val WALLEX_TRANSFER_BENEFICIARY ="WALLEX_TRANSFER_BENEFICIARY"
  val WALLEX_SUPPORTING_DOCUMENT_REQUIRED ="WALLEX_SUPPORTING_DOCUMENT_REQUIRED"
  val WALLEX_CURRENCY_PAIR ="WALLEX_CURRENCY_PAIR"
  val WALLEX_BUY_CURRENCY = "WALLEX_BUY_CURRENCY"
  val WALLEX_SELL_CURRENCY ="WALLEX_SELL_CURRENCY"
  val WALLEX_BUY_AMOUNT = "WALLEX_BUY_AMOUNT"
  val WALLEX_SELL_AMOUNT = "WALLEX_SELL_AMOUNT"
  val WALLEX_FIXED_SIDE = "WALLEX_FIXED_SIDE"
  val WALLEX_RATE = "WALLEX_RATE"
  val WALLEX_PARTNER_RATE ="WALLEX_PARTNER_RATE"
  val WALLEX_PARTNER_BUY_AMOUNT = "WALLEX_PARTNER_BUY_AMOUNT"
  val WALLEX_PARTNER_SELL_AMOUNT = "WALLEX_PARTNER_SELL_AMOUNT"
  val WALLEX_PARTNER_PAYMENT_FEE = "WALLEX_PARTNER_PAYMENT_FEE"
  val WALLEX_EXPIRES_AT = "WALLEX_EXPIRES_AT"
  val WALLEX_QUOTE_ID ="WALLEX_QUOTE_ID"
  val WALLEX_CONVERSION_FEE = "WALLEX_CONVERSION_FEE"
  val WALLEX_PAYMENT_FEE = "WALLEX_PAYMENT_FEE"
  val WALLEX_TOTAL_FEE = "WALLEX_TOTAL_FEE"
  val WALLEX_PAYMENT_CHANNEL ="WALLEX_PAYMENT_CHANNEL"
  val WALLEX_BANK_CHARGE = "WALLEX_BANK_CHARGE"
  val WALLEX_QUOTE_RESPONSE = "WALLEX_QUOTE_RESPONSE"
  val WALLEX_ORGANIZATION_BENEFICIARY ="WALLEX_ORGANIZATION_BENEFICIARY"
  val WALLEX_BENEFICIARY_ID ="WALLEX_BENEFICIARY_ID"
  val COMPANY_NAME ="COMPANY_NAME"
  val ACCOUNT_TYPE ="ACCOUNT_TYPE"
  val WALLEX_ABA ="WALLEX_ABA"
  ...
  val WALLEX_RECEIVER_ACCOUNT_ID = "WALLEX_RECEIVER_ACCOUNT_ID"
  val PURPOSE_OF_TRANSFER = "PURPOSE_OF_TRANSFER"
  val WALLEX_REMARKS = "WALLEX_REMARKS"
  val WALLEX_CREATED_AT = "WALLEX_CREATED_AT"
  val WALLEX_PAY_TO_BENEFICIARY = "WALLEX_PAY_TO_BENEFICIARY"
  val WALLEX_COLLECTION_ACCOUNT = "WALLEX_COLLECTION_ACCOUNT"
  val WALLEX_ACCOUNT_NUMBER_TYPE = "WALLEX_ACCOUNT_NUMBER_TYPE"
  val WALLEX_KYC_DOCUMENTS = "WALLEX_KYC_DOCUMENTS"
  val WALLEX_SUBMIT_DOCUMENT = "WALLEX_SUBMIT_DOCUMENT"
  val WALLEX_SUBMIT_DOCUMENT_TERMS = "WALLEX_SUBMIT_DOCUMENT_TERMS"
  val WALLEX_ON_BEHALF_OF = "WALLEX_ON_BEHALF_OF"
  ...
  val WALLEX_NO_COLLECTION_ACCOUNT = "WALLEX_NO_COLLECTION_ACCOUNT"
  val WALLEX_QUOTE_NOT_RETURNED = "WALLEX_QUOTE_NOT_RETURNED"
  val WALLEX_TERMS_AND_CONDITIONS_TEXT = "WALLEX_TERMS_AND_CONDITIONS_TEXT"
  val WALLEX_TERMS_AND_CONDITIONS = "WALLEX_TERMS_AND_CONDITIONS"
  val WALLEX_COLLECTION_ACCOUNT_ID = "WALLEX_COLLECTION_ACCOUNT_ID"
  val WALLEX_CREATE_COLLECTION_ACCOUNT_MESSAGE = "WALLEX_CREATE_COLLECTION_ACCOUNT_MESSAGE"
  val WALLEX_ADD_FUND_BANK_DETAILS = "WALLEX_ADD_FUND_BANK_DETAILS"
  val WALLEX_ADD_FUND_BANK_DETAILS_MESSAGE = "WALLEX_ADD_FUND_BANK_DETAILS_MESSAGE"
  val WALLEX_ACCOUNT_TYPE = "WALLEX_ACCOUNT_TYPE"
