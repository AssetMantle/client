...
object View {
  ...
  val SIGNIN_FORM_SIGNUP_MSG = "SIGNIN_FORM_SIGNUP_MSG"
  val SIGNIN_FORM_SIGNUP_URL = "SIGNIN_FORM_SIGNUP_URL"
  val SIGNUP_FORM_SUBTITLE = "SIGNUP_FORM_SUBTITLE"
  val SIGNUP_FORM_SIGNIN_MSG = "SIGNUP_FORM_SIGNIN_MSG"
  val SIGNUP_FORM_SIGNIN_URL = "SIGNUP_FORM_SIGNIN_URL"
  val BLOCKS = "BLOCKS"
