...
object View {
  ...
  val REGISTER_TO_AN_ORGANIZATION_NOTE="REGISTER_TO_AN_ORGANIZATION_NOTE"
  val REGISTER_AS_AN_ORGANIZATION_NOTE="REGISTER_AS_AN_ORGANIZATION_NOTE"
