...
object View {
  ...
  val DOCUMENTS_LIST="DOCUMENTS_LIST"
  val INVOICE ="INVOICE"
  val COO ="COO"
  val COA ="COA"
  ...
  val SELLER_REJECTED_NEGOTIATION_LIST = "SELLER_REJECTED_NEGOTIATION_LIST"
  val BUYER_REJECTED_NEGOTIATION_LIST = "BUYER_REJECTED_NEGOTIATION_LIST"
