...
object View {
  ...
  val KYC = "KYC"
  val KYC_ROOMS = "KYC_ROOMS"
  val KYC_ONGOING_LIST = "KYC_ONGOING_LIST"
  val KYC_RECEIVED_LIST = "KYC_RECEIVED_LIST"
  val KYC_REQUESTING = "KYC_REQUESTING"
  val REQUIRED_DOCUMENTS = "REQUIRED_DOCUMENTS"
  val SCREENING_CHECKS = "SCREENING_CHECKS"
  val GO_TO_KYC_ROOM = "GO_TO_KYC_ROOM"
  val SERVICE_PROVIDER_CHECK = "SERVICE_PROVIDER_CHECK"
  val REQUESTING_FOR_CHECK ="REQUESTING_FOR_CHECK"
  val SEARCH ="SEARCH"
