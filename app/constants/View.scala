...
object View {
  ...
  val PASSWORDS_NOT_MATCHED="PASSWORDS_NOT_MATCHED"
  ...
  //docusign
  val DOCUSIGN_EVENT_SEND = "Send"
  val DOCUSIGN_EVENT_SEND_SIGNING_COMPLETE = "signing_complete"
  val AUTHORIZE_DOCUSIGN = "AUTHORIZE_DOCUSIGN"
  val ACCESS_TOKEN_UPDATED = "ACCESS_TOKEN_UPDATED"
  val SIGNED = "SIGNED"
  ...
  val CODE = "code"
  val ENVELOPE_ID_NOT_PRESENT = "ENVELOPE_ID_NOT_PRESENT"
