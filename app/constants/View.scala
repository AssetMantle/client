...
object View {
  ...
  val LEGEND_EXECUTE_AUTHORIZATION = "LEGEND_EXECUTE_AUTHORIZATION"
  val LEGEND_WITHDRAW_REWARD = "LEGEND_WITHDRAW_REWARD"
  val LEGEND_WITHDRAW_COMMISSION = "LEGEND_WITHDRAW_COMMISSION"
  val LEGEND_DELEGATE = "LEGEND_DELEGATE"
  val LEGEND_SEND_COIN = "LEGEND_SEND_COIN"
  val LEGEND_IBC_TRANSFER = "LEGEND_IBC_TRANSFER"
  val LEGEND_IBC_UPDATE_CLIENT = "LEGEND_IBC_UPDATE_CLIENT"
  val LEGEND_IBC_ACKNOWLEDGEMENT = "LEGEND_IBC_ACKNOWLEDGEMENT"
