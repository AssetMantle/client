...
object View {
  ...
  val KEPLR = "KEPLR"
  val ASSET_MANTLE_STATISTICS = "ASSET_MANTLE_STATISTICS"
  ...
  val AUTHENTICATED_ADDRESSES = "AUTHENTICATED_ADDRESSES"
  ...
  val NAMED_IDENTITIES = "NAMED_IDENTITIES"
  val IDENTITY_CLASSES = "IDENTITY_CLASSES"
  val ASSETS = "ASSETS"
  val ASSETS_MINTED = "ASSETS_MINTED"
  val ASSET_CLASSES = "ASSET_CLASSES"
  val ORDERS = "ORDERS"
