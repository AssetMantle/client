...
object FormConstraint {
  ...
  val issueAssetRequestCheckConstraint: Constraint[IssueAssetRequest.Data] = Constraint("constraints.issueAssetRequestCheck")({ confirmTransactionData: IssueAssetRequest.Data =>
    val errors = {
