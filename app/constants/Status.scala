...
object Status {
  ...
  object Negotiation {
    ...
    val REQUEST_SENDING_WAITING_FOR_ISSUE_ASSET = "REQUEST_SENDING_WAITING_FOR_ISSUE_ASSET"
    val REQUEST_SENT = "REQUEST_SENT"

    val ISSUE_ASSET_FAILED = "ISSUE_ASSET_FAILED"

    val NEGOTIATION_STARTED = "NEGOTIATION_STARTED"
    val BUYER_CONFIRMED_BID_SELLER_PENDING = "BUYER_CONFIRMED_BID_SELLER_PENDING"
    val SELLER_CONFIRMED_BID_BUYER_PENDING = "SELLER_CONFIRMED_BID_BUYER_PENDING"
    val BOTH_PARTY_CONFIRMED_BID = "BOTH_PARTY_CONFIRMED_BID"
