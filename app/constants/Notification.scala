...
object Notification {
  ...
  val NEGOTIATION_OTHER_DETAILS_UPDATED = new Notification(notificationType = "NEGOTIATION_OTHER_DETAILS_UPDATED", sendEmail = false, sendPushNotification = true, sendSMS = false)
