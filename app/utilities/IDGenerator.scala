...
object IDGenerator {
  ...
  // westernUnion has max length limit of 30 characters
  def ID30letters()(implicit module: String): String = {
    val initials = module.split("_").foldLeft("")(_ + _.take(1))
    Seq("RQ", initials, (count.getAndIncrement() % 89999 + 10000).toString, (System.currentTimeMillis() % 89999999 + 10000000).toString, Random.alphanumeric.take(30 - initials.length - 15).mkString).mkString("")
  }
