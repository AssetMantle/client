...
object ReleaseAsset {
  val form = Form(
    mapping(
      constants.Form.BLOCKCHAIN_ADDRESS -> nonEmptyText(minLength = constants.FormConstraint.BLOCKCHAIN_ADDRESS_LENGTH, maxLength = constants.FormConstraint.BLOCKCHAIN_ADDRESS_LENGTH),
