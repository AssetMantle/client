...
object IssueAssetOBL {
  ...
  case class Data(requestID: String, billOfLadingNumber: String, portOfLoading: String, shipperName: String, shipperAddress: String, notifyPartyName: String, notifyPartyAddress: String, shipmentDate: Date, deliveryTerm: String, assetQuantity: Int, assetPrice: Int)
