...
object DeputizeOrganization {
  ...
  case class Data(organizationID: String, addTrader:Boolean, createModeratedAsset:Boolean, createUnmoderatedAsset:Boolean, createFiat:Boolean, createOrder:Boolean, gas:MicroNumber, password: String)
