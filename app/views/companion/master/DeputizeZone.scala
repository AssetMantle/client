...
object DeputizeZone {
  ...
  case class Data(zoneID: String, addOrganization: Boolean, addTrader:Boolean, createModeratedAsset:Boolean, createUnmoderatedAsset:Boolean, createOrder:Boolean, gas:MicroNumber, password: String)
