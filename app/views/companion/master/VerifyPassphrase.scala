...
object VerifyPassphrase {
  ...
  case class Data(passphraseElement1: String, passphraseElement2: String, passphraseElement3: String, seed:String, passphraseElementID1 :Int, passphraseElementID2 :Int, passphraseElementID3 :Int)
