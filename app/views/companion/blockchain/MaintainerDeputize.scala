...
object MaintainerDeputize {
  ...
  case class Data(from: String, fromID: String, toID: String, classificationID: String, addMaintainer: Boolean, mutateMaintainer: Boolean, removeMaintainer: Boolean, gas: MicroNumber, maintainedTraits: Option[Seq[Option[Property.Data]]], addMaintainedTraits: Boolean)
