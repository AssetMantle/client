...
object MaintainerDeputize {
  ...
  case class Data(fromID: String, toID: String, classificationID: String, addMaintainer: Boolean, mutateMaintainer: Boolean, removeMaintainer: Boolean, gas: MicroNumber, password: Option[String], maintainedTraits: Option[Seq[Option[Property.Data]]], addMaintainedTraits: Boolean)
