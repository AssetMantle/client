...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.test.GenesisProto.internal_static_test_Genesis_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.test.GenesisProto.internal_static_test_Genesis_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.test.Genesis.class, com.test.Genesis.Builder.class);
  }

  public static final int MAPPABLES_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.test.TestMappable> mappables_;
  /**
   * <code>repeated .test.TestMappable mappables = 1 [json_name = "mappables"];</code>
   */
  @java.lang.Override
  public java.util.List<com.test.TestMappable> getMappablesList() {
    return mappables_;
  }
  /**
   * <code>repeated .test.TestMappable mappables = 1 [json_name = "mappables"];</code>
   */
  @java.lang.Override
  public java.util.List<? extends com.test.TestMappableOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.test.TestMappable getMappables(int index) {
   ...
   */
  @java.lang.Override
  public com.test.TestMappableOrBuilder getMappablesOrBuilder(
      int index) {
    return mappables_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.test.Genesis)) {
      return super.equals(obj);
    }
    com.test.Genesis other = (com.test.Genesis) obj;
  ...
  public static com.test.Genesis parseFrom(
  ...
  public static com.test.Genesis parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.test.Genesis parseFrom(
  ...
  public static com.test.Genesis parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.test.Genesis parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.test.Genesis parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.test.Genesis prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public com.test.Genesis getDefaultInstanceForType() {
      return com.test.Genesis.getDefaultInstance();
    }

    @java.lang.Override
    public com.test.Genesis build() {
      com.test.Genesis result = buildPartial();
    ...
    @java.lang.Override
    public com.test.Genesis buildPartial() {
      com.test.Genesis result = new com.test.Genesis(this);
    ...
    private void buildPartialRepeatedFields(com.test.Genesis result) {
      if (mappablesBuilder_ == null) {
    ...
    private void buildPartial0(com.test.Genesis result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.test.Genesis) {
        return mergeFrom((com.test.Genesis)other);
      } else {
    ...
    public Builder mergeFrom(com.test.Genesis other) {
      if (other == com.test.Genesis.getDefaultInstance()) return this;
      if (mappablesBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.test.TestMappable m =
                  input.readMessage(
                      com.test.TestMappable.parser(),
                      extensionRegistry);
              if (mappablesBuilder_ == null) {
                ensureMappablesIsMutable();
                mappables_.add(m);
    ...
    private void ensureMappablesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        mappables_ = new java.util.ArrayList<com.test.TestMappable>(mappables_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.test.TestMappable, com.test.TestMappable.Builder, com.test.TestMappableOrBuilder> mappablesBuilder_;
    ...
    public Builder setMappables(
        int index, com.test.TestMappable value) {
      if (mappablesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setMappables(
        int index, com.test.TestMappable.Builder builderForValue) {
      if (mappablesBuilder_ == null) {
        ensureMappablesIsMutable();
     ...
     * <code>repeated .test.TestMappable mappables = 1 [json_name = "mappables"];</code>
     */
    public Builder addMappables(com.test.TestMappable value) {
      if (mappablesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addMappables(
        com.test.TestMappable.Builder builderForValue) {
      if (mappablesBuilder_ == null) {
        ensureMappablesIsMutable();
    ...
    public Builder addAllMappables(
        java.lang.Iterable<? extends com.test.TestMappable> values) {
      if (mappablesBuilder_ == null) {
        ensureMappablesIsMutable();
     ...
     * <code>repeated .test.TestMappable mappables = 1 [json_name = "mappables"];</code>
     */
    public com.test.TestMappable.Builder getMappablesBuilder(
        int index) {
     ...
     * <code>repeated .test.TestMappable mappables = 1 [json_name = "mappables"];</code>
     */
    public com.test.TestMappable.Builder addMappablesBuilder() {
      return getMappablesFieldBuilder().addBuilder(
          com.test.TestMappable.getDefaultInstance());
    }
    /**
     * <code>repeated .test.TestMappable mappables = 1 [json_name = "mappables"];</code>
     */
    public com.test.TestMappable.Builder addMappablesBuilder(
        int index) {
      return getMappablesFieldBuilder().addBuilder(
          index, com.test.TestMappable.getDefaultInstance());
    }
    /**
     * <code>repeated .test.TestMappable mappables = 1 [json_name = "mappables"];</code>
     */
    public java.util.List<com.test.TestMappable.Builder> 
         getMappablesBuilderList() {
      return getMappablesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.test.TestMappable, com.test.TestMappable.Builder, com.test.TestMappableOrBuilder> 
  ...
  private static final com.test.Genesis DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.test.Genesis();
  }

  public static com.test.Genesis getDefaultInstance() {
