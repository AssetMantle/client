...
class ReleaseAsset @Inject()(configuration: Configuration, wsClient: WSClient, executionContext: ExecutionContext) {
  ...
  class Request(from: String, to: String, pegHash: String, chainID: String, password: String, gas: Int) {
