...
@Singleton
class SplitUnwrap @Inject()(wsClient: WSClient)(implicit configuration: Configuration, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.TRANSACTIONS_SPLIT_UNWRAP
  ...
  case class Message(baseReq: BaseReq, fromID: String, ownableID: String, split: BigDecimal)
  ...
  private implicit val requestWrites: Writes[Request] = (request: Request) => Json.obj(
    "type" -> constants.Blockchain.TransactionRequest.SPLIT_UNWRAP,
