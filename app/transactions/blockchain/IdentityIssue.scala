...
@Singleton
class IdentityIssue @Inject()(wsClient: WSClient)(implicit configuration: Configuration, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.TRANSACTIONS_IDENTITY_ISSUE
  ...
  private val path = "xprt/identities/issue"
  ...
  case class Message(baseReq: BaseReq, fromID: String, classificationID: String, to: String, immutableMetaProperties: Seq[Property.Data], immutableProperties: Seq[Property.Data], mutableMetaProperties: Seq[Property.Data], mutableProperties: Seq[Property.Data])
  ...
  private implicit val requestWrites: Writes[Request] = (request: Request) => Json.obj(
    "type" -> constants.Blockchain.TransactionRequest.IDENTITY_ISSUE,
