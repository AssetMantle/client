...
class IssueAsset @Inject()(wsClient: WSClient)(implicit configuration: Configuration, executionContext: ExecutionContext) {
  ...
  case class Request(base_req: BaseRequest, to: String, documentHash: String, assetType: String, assetPrice: String, quantityUnit: String, assetQuantity: String,gas:String , takerAddress: String, mode: String, password: String, moderated: Boolean) extends RequestEntity
