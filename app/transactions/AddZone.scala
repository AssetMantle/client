...
class AddZone @Inject()(configuration: Configuration, wsClient: WSClient, executionContext: ExecutionContext) {
  ...
  class Request(from: String, to: String, zoneID: String, chainID: String, password: String) {
