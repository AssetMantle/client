...
class ConfirmSellerBid @Inject()(wsClient: WSClient)(implicit configuration: Configuration, executionContext: ExecutionContext) {
  ...
  case class Request(base_req: BaseRequest, password: String, to: String, bid: Int, time: Int, pegHash: String, sellerContractHash: String, mode: String) extends RequestEntity
