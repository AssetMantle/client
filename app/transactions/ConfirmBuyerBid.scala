...
class ConfirmBuyerBid @Inject()(wsClient: WSClient)(implicit configuration: Configuration, executionContext: ExecutionContext) {
  ...
  case class Request(base_req: BaseRequest, password: String, to: String, bid: String, time: String, pegHash: String, buyerContractHash: String, mode: String) extends BaseRequestEntity
