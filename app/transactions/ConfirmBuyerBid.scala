...
class ConfirmBuyerBid @Inject()(wsClient: WSClient)(implicit configuration: Configuration, executionContext: ExecutionContext) {
  ...
  case class Request(base_req: BaseRequest, password: String, to: String, bid: Int, time: Int, pegHash: String, buyerContractHash: String, mode: String, gas: Int) extends RequestEntity
