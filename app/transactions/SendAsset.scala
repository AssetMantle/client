...
@Singleton
class SendAsset @Inject()(wsClient: WSClient)(implicit configuration: Configuration, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.TRANSACTIONS_SEND_ASSET
  ...
  case class Request(base_req: BaseRequest, password: String, to: String, pegHash: String, gas:String,mode: String) extends BaseRequestEntity
