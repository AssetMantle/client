...
class Splits @Inject()(
  ...
  object Utility {
    ...
    def exchangeAuxiliaryCustody(makerID: String, makerSplitID: String, makerSplit: BigDecimal): Future[Unit] = {
      ...
      val splitMint = auxiliaryMint(ownerID = constants.Blockchain.Module.Exchanges, ownableID = makerSplitID, splitValue = makerSplit)
    ...
    def exchangeAuxiliaryReverse(makerID: String, makerSplitID: String, makerSplit: BigDecimal): Future[Unit] = {
      val splitBurn = auxiliaryBurn(ownerID = constants.Blockchain.Module.Exchanges, ownableID = makerSplitID, splitValue = makerSplit)
    ...
    def exchangeAuxiliarySwap(makerID: String, makerSplitID: String, makerSplit: BigDecimal, takerID: String, takerSplitID: String, takerSplit: BigDecimal): Future[Unit] = {
      val makerSplitBurn = auxiliaryBurn(ownerID = constants.Blockchain.Module.Exchanges, ownableID = makerSplitID, splitValue = makerSplit)
