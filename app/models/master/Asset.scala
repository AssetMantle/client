...
case class Asset(id: String, ownerID: String, pegHash: Option[String] = None, assetType: String, description: String, documentHash: String, quantity: Int, quantityUnit: String, price: MicroLong, moderated: Boolean, takerID: Option[String] = None, otherDetails: AssetOtherDetails, status: String, createdBy: Option[String] = None, createdOn: Option[Timestamp] = None, createdOnTimeZone: Option[String] = None, updatedBy: Option[String] = None, updatedOn: Option[Timestamp] = None, updatedOnTimeZone: Option[String] = None) extends Logged
...
class Assets @Inject()(protected val databaseConfigProvider: DatabaseConfigProvider)(implicit executionContext: ExecutionContext) {
  ...
  private def generateDocumentHash(assetID: String, ownerID: String, assetType: String, description: String, quantity: Int, quantityUnit: String, price: MicroLong, moderated: Boolean): String = utilities.String.sha256Sum(Seq(assetID, ownerID, assetType, description, quantity.toString(), quantity, price.microString, moderated.toString()).mkString(""))
  ...
  object Service {
    ...
    def addModerated(ownerID: String, assetType: String, description: String, quantity: Int, quantityUnit: String, price: MicroLong, shippingPeriod: Int, portOfLoading: String, portOfDischarge: String): Future[String] = {
    ...
    def addUnmoderated(ownerID: String, assetType: String, description: String, quantity: Int, quantityUnit: String, price: MicroLong, shippingPeriod: Int, portOfLoading: String, portOfDischarge: String): Future[String] = {
      val id = utilities.IDGenerator.requestID()
