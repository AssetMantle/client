        ...
        try {
          ...
          userType match {
            case constants.User.GENESIS =>
              withUsernameToken.Ok(views.html.genesisHome(username = loginData.username, address = address, coins = blockchainAccounts.Service.getCoins(address), profilePicture = masterAccountFiles.Service.getProfilePicture(loginData.username)), loginData.username)
            case constants.User.ZONE =>
              withUsernameToken.Ok(views.html.zoneHome(username = loginData.username, address = address, coins = blockchainAccounts.Service.getCoins(address), zone = masterZones.Service.get(blockchainZones.Service.getID(address)), profilePicture = masterAccountFiles.Service.getProfilePicture(loginData.username)), loginData.username)
            case constants.User.ORGANIZATION =>
              withUsernameToken.Ok(views.html.organizationHome(username = loginData.username, address = address, coins = blockchainAccounts.Service.getCoins(address), organization = masterOrganizations.Service.get(blockchainOrganizations.Service.getID(address)), profilePicture = masterAccountFiles.Service.getProfilePicture(loginData.username)), loginData.username)
            ...
            case constants.User.USER =>
              withUsernameToken.Ok(views.html.userHome(username = loginData.username, address = address, coins = blockchainAccounts.Service.getCoins(address), profilePicture = masterAccountFiles.Service.getProfilePicture(loginData.username)), loginData.username)
            case constants.User.UNKNOWN =>
              withUsernameToken.Ok(views.html.unknownHome(username = loginData.username, address = address, profilePicture = masterAccountFiles.Service.getProfilePicture(loginData.username)), loginData.username)
