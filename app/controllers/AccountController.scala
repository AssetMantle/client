...
class AccountController @Inject()(
  ...
  def addIdentificationForm(): Action[AnyContent] = withUserLoginAction { implicit loginState =>
    implicit request =>
  ...
  def addIdentification(): Action[AnyContent] = withUserLoginAction { implicit loginState =>
    implicit request =>
