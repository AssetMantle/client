  ...
  def javascriptRoutes = Action { implicit request =>
    Ok(
      JavaScriptReverseRouter("jsRoutes")(
        ...
        routes.javascript.JavaScriptResourceController.commonHome,
        routes.javascript.JavaScriptResourceController.assetPegWallet,
        routes.javascript.JavaScriptResourceController.fiatPegWallet,
        routes.javascript.JavaScriptResourceController.negotiation,
        routes.javascript.JavaScriptResourceController.order,
