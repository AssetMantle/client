  ...
  def javascriptRoutes = Action { implicit request =>
    Ok(
      JavaScriptReverseRouter("jsRoutes")(
        ...
        routes.javascript.AssetController.addBillOfLadingContentForm,
        ...
        routes.javascript.NegotiationController.addInvoiceContentForm,
        routes.javascript.NegotiationController.addContractContentForm,
