  ...
  def javascriptRoutes = withoutLoginAction { implicit request =>
    Ok(
      JavaScriptReverseRouter("jsRoutes")(
        ...
        routes.javascript.ViewController.wallex,
        ...
        routes.javascript.WallexController.updateWallexAccount,
        routes.javascript.WallexController.addWallexDocumentForm,
        routes.javascript.WallexController.uploadOrUpdateWallexDocument,
        routes.javascript.WallexController.addWallexDocument,
        routes.javascript.WallexController.initiateWallexPaymentForm,
        routes.javascript.WallexController.initiateWallexPayment,
        routes.javascript.WallexController.acceptWallexQuoteForm,
        routes.javascript.WallexController.acceptWallexQuote,
