...
class ViewController @Inject()(
  ...
  def genesisRequest: Action[AnyContent] = withGenesisLoginAction { implicit loginState =>
    implicit request =>
      Future {
  ...
  def zoneRequest: Action[AnyContent] = withZoneLoginAction { implicit loginState =>
    implicit request =>
      Future {
  ...
  def trades: Action[AnyContent] = withLoginActionAsync { implicit loginState =>
    implicit request =>
      (for {
  ...
  def transactions: Action[AnyContent] = withLoginActionAsync{ implicit loginState =>
    implicit request =>
      (for {
  ...
  def tradeRoom(id: String): Action[AnyContent] = withLoginActionAsync { implicit loginState =>
    implicit request =>
      (for {
  ...
  def tradeRoomCompleted(id: String): Action[AnyContent] = withLoginActionAsync { implicit loginState =>
    implicit request =>
      (for {
