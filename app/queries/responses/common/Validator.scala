...
object Validator {
  ...
  def resultApply(operator_address: String, consensus_pubkey: PublicKey, jailed: Boolean, status: String, tokens: String, delegator_shares: BigDecimal, description: Description, unbonding_height: String, unbonding_time: RFC3339, commission: Commission, min_self_delegation: String): Result = Result(
  ...
  implicit val resultReads: Reads[Result] = (
    (JsPath \ "operator_address").read[String] and
      ...
      (JsPath \ "unbonding_time").read[RFC3339] and
