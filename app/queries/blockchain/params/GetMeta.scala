...
import queries.responses.blockchain.params.MetaResponse.Response
...
@Singleton
class GetMeta @Inject()()(implicit wsClient: WSClient, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.QUERIES_GET_PARAMS_META

  private implicit val logger: Logger = Logger(this.getClass)

  private val path = "metas/parameters"
