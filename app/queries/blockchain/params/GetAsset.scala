...
import queries.responses.blockchain.params.AssetResponse.Response
...
@Singleton
class GetAsset @Inject()()(implicit wsClient: WSClient, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.QUERIES_GET_PARAMS_ASSET

  private implicit val logger: Logger = Logger(this.getClass)

  private val path = "assets/parameters"
