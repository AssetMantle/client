...
import queries.responses.blockchain.params.ClassificationResponse.Response
...
@Singleton
class GetClassification @Inject()()(implicit wsClient: WSClient, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.QUERIES_GET_PARAMS_CLASSIFICATION

  private implicit val logger: Logger = Logger(this.getClass)

  private val path = "classifications/parameters"
