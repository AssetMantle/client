...
import queries.responses.blockchain.params.OrderResponse.Response
...
@Singleton
class GetOrder @Inject()()(implicit wsClient: WSClient, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.QUERIES_GET_PARAMS_ORDER

  private implicit val logger: Logger = Logger(this.getClass)

  private val path = "orders/parameters"
