...
import queries.responses.blockchain.params.IdentityResponse.Response
...
@Singleton
class GetIdentity @Inject()()(implicit wsClient: WSClient, executionContext: ExecutionContext) {

  private implicit val module: String = constants.Module.QUERIES_GET_PARAMS_IDENTITY

  private implicit val logger: Logger = Logger(this.getClass)

  private val path = "identities/parameters"
