...
import queries.responses.memberCheck.MemberScanResponse.Response
...
@Singleton
class GetMemberScan @Inject()(wsClient: WSClient, keyStore: KeyStore)(implicit configuration: Configuration, executionContext: ExecutionContext) {
