...
import queries.responses.memberCheck.CorporateScanResponse.Response
...
@Singleton
class GetCorporateScan @Inject()(wsClient: WSClient, keyStore: KeyStore)(implicit configuration: Configuration, executionContext: ExecutionContext) {
