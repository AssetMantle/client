        ...
        statusCode: {
            200: function (validatorListData) {
                ...
                Array.prototype.forEach.call(validatorListData, validator => {
                    content = content + "<tr><td><p> <span id=\"text_element\" class=\"hash_code\"> "+ validator.operator_address + "</span><span onclick=\"copyToClipboard('text_element')\" class=\"tooltip\"><span class=\"tooltiptext\" id=\"myTooltip\">Copy to clipboard</span><span class='copyIcon' cmuk-icon=\"copy\" onmouseout=\"afterCopy()\"></span></span></p></td><td>" + validator.status + "</td><td >" + validator.tokens + "</div></td></td><td ><span class=\"hash_code\" title='" + validator.delegator_shares + "'>" + validator.delegator_shares + "</span></td></tr>";
                });
